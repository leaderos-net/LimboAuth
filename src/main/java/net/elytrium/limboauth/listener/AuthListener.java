...
public class AuthListener {
    ...
    public void onPostLogin(PostLoginEvent event) {
        ...
        if (postLoginTask != null) {
            ...
            this.plugin.getServer().getScheduler().buildTask(this.plugin, postLoginTask).delay(Settings.IMP.MAIN.PREMIUM_AND_FLOODGATE_MESSAGES_DELAY, TimeUnit.MILLISECONDS).schedule();
        }
    }
